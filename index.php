        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="#"><?php $str = (isset($_GET["page"])) ? (($_GET["page"] == "nilai") ? "persyaratan" : $_GET["page"]) : "dashboard"; echo strtoupper($str)?></a>
                </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <?php $query = $connection->query("SELECT * FROM beasiswa"); while ($row = $query->fetch_assoc()): ?>
                                    <li><a href="?page=perhitungan&beasiswa=<?=$row["kd_beasiswa"]?>"><?=$row["nama_beasiswa"]?></a></li>
                                <?php endwhile; ?>
                            </ul>
                        </li>
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=beasiswa">Data Jenis Beasiswa</a></li>
                            <li class="divider"></li>
